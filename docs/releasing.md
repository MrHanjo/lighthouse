...
# zip the extension files, but remove bundle-entry as it's already bundled
cd lighthouse-extension; command rm -f dist/scripts/bundle-entry.js; gulp package; cd ..
